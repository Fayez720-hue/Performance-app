...
export default function ReportsPageClient() {
  ...
  // Dummy metrics (replace with real data from stats if available)
  const metrics = [
    {
  ...
  const performanceTrends = [
    { range: "0-20%", count: stats?.buckets?.["0-20"] || 0 },
    { range: "21-40%", count: stats?.buckets?.["21-40"] || 0 },
    { range: "41-60%", count: stats?.buckets?.["41-60"] || 0 },
    { range: "61-80%", count: stats?.buckets?.["61-80"] || 0 },
    { range: "81-100%", count: stats?.buckets?.["81-100"] || 0 }
  ];
