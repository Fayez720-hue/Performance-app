...
var BuildId = "8fNmEfkvlmeLQvqd6OgGZ";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/dashboard-data/route": "/api/dashboard-data", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/debug-users/route": "/api/debug-users", "/api/notifications/route": "/api/notifications", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/dashboard/route": "/api/dashboard", "/api/tasks/route": "/api/tasks", "/api/users/route": "/api/users", "/admin/users/page": "/admin/users", "/login/page": "/login", "/reports/page": "/reports", "/settings/page": "/settings", "/page": "/", "/dashboard/page": "/dashboard", "/tasks/new/page": "/tasks/new", "/tasks/page": "/tasks", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
