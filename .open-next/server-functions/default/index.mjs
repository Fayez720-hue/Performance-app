...
var BuildId = "uL3goj3ahCib_esysOlWf";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/dashboard/route": "/api/dashboard", "/api/dashboard-data/route": "/api/dashboard-data", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/debug-users/route": "/api/debug-users", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/notifications/route": "/api/notifications", "/api/tasks/route": "/api/tasks", "/api/users/route": "/api/users", "/admin/users/page": "/admin/users", "/tasks/new/page": "/tasks/new", "/login/page": "/login", "/tasks/page": "/tasks", "/dashboard/page": "/dashboard", "/settings/page": "/settings", "/page": "/", "/reports/page": "/reports", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
