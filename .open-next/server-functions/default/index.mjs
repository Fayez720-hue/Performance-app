...
var BuildId = "9X8n3PJp5axVNoo6YQYY0";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/dashboard-data/route": "/api/dashboard-data", "/api/debug-users/route": "/api/debug-users", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/tasks/route": "/api/tasks", "/api/notifications/route": "/api/notifications", "/api/users/route": "/api/users", "/api/dashboard/route": "/api/dashboard", "/admin/users/page": "/admin/users", "/login/page": "/login", "/dashboard/page": "/dashboard", "/tasks/new/page": "/tasks/new", "/reports/page": "/reports", "/settings/page": "/settings", "/page": "/", "/tasks/page": "/tasks", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
