...
var BuildId = "V95ZusgvNFFI6EKXe8kYB";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/debug-users/route": "/api/debug-users", "/api/dashboard-data/route": "/api/dashboard-data", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/notifications/route": "/api/notifications", "/api/dashboard/route": "/api/dashboard", "/api/tasks/route": "/api/tasks", "/api/users/route": "/api/users", "/admin/users/page": "/admin/users", "/dashboard/page": "/dashboard", "/reports/page": "/reports", "/login/page": "/login", "/page": "/", "/settings/page": "/settings", "/tasks/new/page": "/tasks/new", "/tasks/page": "/tasks", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
