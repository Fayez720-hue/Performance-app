...
var BuildId = "CXaYL3hD3aTSz_js9HGKE";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/dashboard-data/route": "/api/dashboard-data", "/api/debug-users/route": "/api/debug-users", "/api/notifications/route": "/api/notifications", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/dashboard/route": "/api/dashboard", "/api/users/route": "/api/users", "/api/tasks/route": "/api/tasks", "/admin/users/page": "/admin/users", "/login/page": "/login", "/reports/page": "/reports", "/tasks/new/page": "/tasks/new", "/settings/page": "/settings", "/page": "/", "/dashboard/page": "/dashboard", "/tasks/page": "/tasks", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
