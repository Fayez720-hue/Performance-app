...
var BuildId = "6ZzyvUhH9RViALyyUq7XS";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/dashboard-data/route": "/api/dashboard-data", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/notifications/route": "/api/notifications", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/users/route": "/api/users", "/api/dashboard/route": "/api/dashboard", "/api/tasks/route": "/api/tasks", "/api/debug-users/route": "/api/debug-users", "/admin/users/page": "/admin/users", "/login/page": "/login", "/reports/page": "/reports", "/dashboard/page": "/dashboard", "/settings/page": "/settings", "/tasks/page": "/tasks", "/page": "/", "/tasks/new/page": "/tasks/new", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
