...
var BuildId = "DghB8DMSozw5eaXIN1J-h";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/dashboard/route": "/api/dashboard", "/api/notifications/route": "/api/notifications", "/api/dashboard-data/route": "/api/dashboard-data", "/api/debug-users/route": "/api/debug-users", "/api/debug-env/route": "/api/debug-env", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/tasks/route": "/api/tasks", "/api/users/route": "/api/users", "/dashboard/page": "/dashboard", "/admin/users/page": "/admin/users", "/reports/page": "/reports", "/page": "/", "/settings/page": "/settings", "/tasks/page": "/tasks", "/login/page": "/login", "/tasks/new/page": "/tasks/new", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
