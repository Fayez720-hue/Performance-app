...
var BuildId = "VoUnwUBZTTCnM9PzRxdGU";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/dashboard-data/route": "/api/dashboard-data", "/api/notifications/route": "/api/notifications", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/dashboard/route": "/api/dashboard", "/api/tasks/[id]/route": "/api/tasks/[id]", "/api/debug-users/route": "/api/debug-users", "/api/users/route": "/api/users", "/api/tasks/route": "/api/tasks", "/admin/users/page": "/admin/users", "/login/page": "/login", "/reports/page": "/reports", "/settings/page": "/settings", "/page": "/", "/tasks/new/page": "/tasks/new", "/dashboard/page": "/dashboard", "/tasks/page": "/tasks", "/tasks/[id]/edit/page": "/tasks/[id]/edit" };
